...
class DoctorManager(BaseUserManager):
    def create_doctor(self, user, longitude, latitude, specialite, appointment_price, address, cabinet=None):
        try:
            ...
            if not specialite:
                raise ValidationError("La spécialité est requise pour créer un docteur.")
            ...
            raise ValidationError("Erreur lors de la création du docteur, vérifiez les données saisies.")
